export const GAUNTLET_SYSTEM_PROMPT = `You are the iSolvRisk Gauntlet Formatting Engine.
...
export const HITCHHIKERS_GUIDE_SYSTEM_PROMPT = `You are the iSolvRisk Hitchhiker’s Guide Formatting Engine.
...
- A client-specific or organization-specific title
